...
import { Users, Lock, Globe, Search, RefreshCw, Play, AlertCircle, Loader2, Sparkles, Layers } from 'lucide-react';
...
export default function PublicLobbiesPage() {
  ...
  // Realtime subscription + 20s auto-refresh fallback
  useEffect(() => {
    ...
    <div className="min-h-screen flex flex-col justify-between">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 mb-8">
          <div>
            <div
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-extrabold uppercase tracking-wider mb-3 shadow-sm"
              style={{
            ...
            <p className="text-slate-300 text-xs sm:text-sm mt-1.5 leading-relaxed">
              {lastRefreshed
                ? `Last synced at ${lastRefreshed.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })}`
                : 'Browse active public rooms hosted by other players looking for an opponent.'}
            </p>
          </div>
        ...
        {loading && rooms.length === 0 && (
          <div className="game-panel p-16 rounded-3xl text-center flex flex-col items-center gap-4">
            <Loader2 className="w-10 h-10 text-cyan-400 animate-spin" />
            <p className="text-slate-300 text-sm font-bold">Scanning for active game lobbies…</p>
          </div>
        )}

        {/* Error State */}
        {error && !loading && (
          <div className="game-panel p-8 rounded-3xl text-center flex flex-col items-center gap-4 mb-6 border-red-500/30">
            <div
        ...
        {!loading && !error && filteredRooms.length === 0 && (
          <div className="game-panel p-12 rounded-3xl text-center flex flex-col items-center max-w-md mx-auto my-8">
            <div
            ...
            <h3 className="text-xl font-black text-white mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>
              {searchQuery ? 'No Lobbies Match Your Search' : 'No Public Lobbies Online'}
            </h3>
            ...
            <div>
              {searchQuery ? (
                ...
                <Link
                  ...
                  className="game-btn-primary py-3 px-6 text-sm font-extrabold rounded-2xl inline-flex items-center gap-2"
                >
